...
Table \ref{tab_merge} displays the weighed average price and the producer surplus before and after the merger and quantifies the absolute and relative difference between those two scenarios.
While $\bar{p}$ increases by 3.3\%, the producer surplus even increases by 3.5\%.
This represents the incremental profit due to higher market concentration and less price competition with beer brands that targeted similar-preferences customers.
